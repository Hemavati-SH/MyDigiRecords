Feature: MDR Mobile Test Automation for Profile
  ...
  Scenario Outline: User perfoms Edit profile functionality
    ...
    Examples: 
      ...
      #| india         | rahul@mydigirecords.com | Test@123 | Pratik     | shyam       | surve     | 04071995 | B+          | Male   | Profile | 1234567890 | Amravati | Father       |
      | United States | jhon@gmail.com | Testing@88 | Jhon    | S       | Smith     | 04071995 | B+          | Male   | Profile | 1234567890 | Amravati | Father       |
