...
Feature: MDR Mobile Test Automation for Members
  ...
  Scenario Outline: User perfoms Add Members functionality
    ...
    Examples: 
      ...
      | india         | tanvighingankar@gmail.com | Test@123 | Akash      | t           | test      | 04071995 | B+          | Male   | members |
      | United States | tanvighingankar@gmail.com | Test@123 | Akash      | t           | test      | 04071995 | B+          | Male   | members |
